	...
	static function getDefaultSettings($fullDefinition = false, $fromDatabase = true)
	{
		...
		if ($fullDefinition)
		{
			...
			$data = array(
				...
				'imageBehaviour'              => array('type' => 'select', 'default' => $data['imageBehaviour']             , 'description' => $descriptions['imageBehaviour']             , 'group' => __('Display', 'slideshow-plugin')      , 'options' => array('natural' => __('Natural and centered', 'slideshow-plugin'), 'zoom' => __('Zoom to fit', 'slideshow-plugin'), 'stretch' => __('Stretch to fit', 'slideshow-plugin'))),
