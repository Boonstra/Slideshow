slideshow_jquery_image_gallery_backend_script.slideshow.slideManager = function()
{
	...
	/**
	 * 2.3.0 Code is stored here temporarily until the cleanup.
	 */
	self.twoPointThree = function()
	{
...
//				self.indexImageOrder();
			...
			cancel: 'input, select, textarea, span, .slideshow-slide-editor'
		});

		self.$slideshowSlideEditor = self.$slidesMetaBox.find('.slideshow-slide-editor');
...
//			if (self.$slideshowSlideEditor.is(':visible'))
//			{console.log('hiding');
//				self.$slideshowSlideEditor.animate({height: '0px'});
//			}
//			else
//			{console.log('showing');
//				self.$slideshowSlideEditor.animate({height: '500px'});
//			}
		});
	};
