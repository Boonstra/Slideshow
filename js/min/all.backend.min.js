...
slideshow_jquery_image_gallery_backend_script.generalSettings=function(){var e=jQuery,t={};return t.isCurrentPage=!1,t.init=function(){"slideshow_page_general_settings"===window.pagenow&&(t.isCurrentPage=!0,t.activateUserCapabilities())},t.activateUserCapabilities=function(){e(".general-settings-capability-checkbox").change(function(t){var i,s,a,r=e(t.currentTarget),l="slideshow-jquery-image-gallery-add-slideshows",d="slideshow-jquery-image-gallery-edit-slideshows",c="slideshow-jquery-image-gallery-delete-slideshows",n="slideshow-jquery-image-gallery-add-settings-profiles",g="slideshow-jquery-image-gallery-edit-settings-profiles",o="slideshow-jquery-image-gallery-delete-settings-profiles";"checkbox"==r.attr("type").toLowerCase()&&(i=r.attr("id").split("_"),s=i.shift(),a=i.join("_"),s!==d||r.attr("checked")?(s===l||s===c)&&e("#"+d+"_"+a).attr("checked",!0):(e("#"+l+"_"+a).attr("checked",!1),e("#"+c+"_"+a).attr("checked",!1)),console.log(s,a,g,s===g),s!==g||r.attr("checked")?(s===n||s===o)&&e("#"+g+"_"+a).attr("checked",!0):(e("#"+n+"_"+a).attr("checked",!1),e("#"+o+"_"+a).attr("checked",!1)))})},e(document).bind("slideshowBackendReady",t.init),t}();
