function onYouTubeIframeAPIReady(){slideshow_jquery_image_gallery_script.youTubeAPIReady=!0}slideshow_jquery_image_gallery_backend_script_scriptsloadedFlag=!1,slideshow_jquery_image_gallery_script=function(){var e=jQuery,s={};return s.slideshowInstances={},s.initialized=!1,s.youTubeAPIReady=!1,s.init=function(){slideshow_jquery_image_gallery_backend_script_scriptsloadedFlag!==!0||s.initialized||(s.initialized=!0,e(document).trigger("slideshow_jquery_image_gallery_script_ready"),s.loadYouTubeAPI(),s.repairStylesheetURLs(),s.activateSlideshows(),e(document).trigger("slideshow_jquery_image_gallery_slideshows_ready"))},s.getSlideshowInstance=function(t){var i,n;if(isNaN(parseInt(t,10))){if(t instanceof e&&t.length>0)for(n in s.slideshowInstances)if(s.slideshowInstances.hasOwnProperty(n))if(e.isArray(s.slideshowInstances[n])){for(i=0;i<s.slideshowInstances[n].length;i++)if(s.slideshowInstances[n][i]instanceof s.Slideshow&&s.slideshowInstances[n][i].$container.get(0)===t.get(0))return s.slideshowInstances[n][i]}else if(s.slideshowInstances[n]instanceof s.Slideshow&&s.slideshowInstances[n].$container.get(0)===t.get(0))return s.slideshowInstances[n]}else if(s.slideshowInstances[t]instanceof s.Slideshow||e.isArray(s.slideshowInstances[t]))return s.slideshowInstances[t];return null},s.activateSlideshows=function(){e.each(jQuery(".slideshow_container"),function(t,i){var n,a=e(i),l=a.attr("data-slideshow-activated"),o=a.data("slideshowId");l||(isNaN(parseInt(o,10))&&(o=a.attr("data-slideshow-id")),n=new s.Slideshow(a),e.isArray(s.slideshowInstances[o])?s.slideshowInstances[o].push(n):s.slideshowInstances[o]=s.slideshowInstances[o]instanceof s.Slideshow?[s.slideshowInstances[o],n]:n,a.attr("data-slideshow-activated",!0))})},s.loadYouTubeAPI=function(){if(s.loadYouTubeAPICalled=!0,!(e(".slideshow_slide_video").length<=0)){var t=document.createElement("script"),i=document.getElementsByTagName("script")[0];t.src="//www.youtube.com/iframe_api",i.parentNode.insertBefore(t,i)}},s.repairStylesheetURLs=function(){var t=e('[id*="slideshow-jquery-image-gallery-ajax-stylesheet_"]');return t.length<=0?(s.generateStylesheetURLs(!1),void 0):(e.each(t,function(s,t){var i,n,a,l=e(t),o=e(t).attr("href");void 0!==o&&""!==o&&(i=l.attr("id").split("_"),n=i.splice(1,i.length-1).join("_").slice(0,-4),a=o.split("?"),(void 0===a[1]||""===a[1]||a[1].toLowerCase().indexOf("style=")<0)&&(a[1]="action=slideshow_jquery_image_gallery_load_stylesheet&style="+n+"&ver="+Math.round((new Date).getTime()/1e3),o=a.join("?"),l.attr("href",o)))}),void 0)},s.generateStylesheetURLs=function(s){var t=e(".slideshow_container"),i=window.slideshow_jquery_image_gallery_script_adminURL;t.length<=0||"string"!=typeof i||i.length<=0||e.each(t,function(t,n){var a,l,o=e(n),r=o.attr("data-style-name"),d=o.attr("data-style-version"),h="slideshow-jquery-image-gallery-ajax-stylesheet_"+r+"-css";if("string"==typeof r&&"string"==typeof d&&r.length>0&&d.length>0){if(!s&&"boolean"==typeof s&&(a=e("#"+h),a.length>0))return;l=i+"admin-ajax.php?action=slideshow_jquery_image_gallery_load_stylesheet&style="+r+"&ver="+d,e("head").append('<link rel="stylesheet" id="'+h+'" href="'+l+'" type="text/css" media="all">')}})},e(document).ready(function(){s.init()}),e(window).load(function(){s.init()}),e.fn.getSlideshowInstance=function(){return s.getSlideshowInstance(this)},s}();
