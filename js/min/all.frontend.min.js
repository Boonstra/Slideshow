...
!function(){var t=jQuery,i=slideshow_jquery_image_gallery_script;i.Slideshow.prototype.animateTo=function(i,e){if(!(this.isVideoPlaying()||0>i||i>=this.$views.length||i==this.currentViewID)){if(this.currentlyAnimating===!0)return this.$container.one("slideshowAnimationEnd",t.proxy(function(){this.playState===this.PlayStates.PLAYING&&(this.pause(this.PlayStates.TEMPORARILY_PAUSED),this.play()),this.animateTo(i,e)},this)),void 0;this.currentlyAnimating=!0,(isNaN(parseInt(e,10))||0==e)&&(e=i<this.currentViewID?-1:1),this.visibleViews=[this.currentViewID,i];var s=this.settings.animation,n=["slide","slideRight","slideUp","slideDown","fade","directFade"];"random"==s&&(s=n[Math.floor(Math.random()*n.length)]);var a={slide:"slideRight",slideRight:"slide",slideUp:"slideDown",slideDown:"slideUp",fade:"fade",directFade:"directFade"};0>e&&(s=a[s]);var o=t(this.$views[this.currentViewID]),h=t(this.$views[i]);switch(o.stop(!0,!0),h.stop(!0,!0),h.addClass("slideshow_nextView"),this.recalculateVisibleViews(),this.currentViewID=i,this.$container.trigger("slideshowAnimationStart",[i,s]),s){case"slide":h.css({top:0,left:this.$content.width()}),o.animate({left:-o.outerWidth(!0)},1e3*this.settings.slideSpeed),h.animate({left:0},1e3*this.settings.slideSpeed),setTimeout(t.proxy(function(){o.stop(!0,!0).css("top",this.$container.outerHeight(!0))},this),1e3*this.settings.slideSpeed);break;case"slideRight":h.css({top:0,left:-this.$content.width()}),o.animate({left:o.outerWidth(!0)},1e3*this.settings.slideSpeed),h.animate({left:0},1e3*this.settings.slideSpeed),setTimeout(t.proxy(function(){o.stop(!0,!0).css("top",this.$container.outerHeight(!0))},this),1e3*this.settings.slideSpeed);break;case"slideUp":h.css({top:this.$content.height(),left:0}),o.animate({top:-o.outerHeight(!0)},1e3*this.settings.slideSpeed),h.animate({top:0},1e3*this.settings.slideSpeed),setTimeout(t.proxy(function(){o.stop(!0,!0).css("top",this.$container.outerHeight(!0))},this),1e3*this.settings.slideSpeed);break;case"slideDown":h.css({top:-this.$content.height(),left:0}),o.animate({top:o.outerHeight(!0)},1e3*this.settings.slideSpeed),h.animate({top:0},1e3*this.settings.slideSpeed),setTimeout(t.proxy(function(){o.stop(!0,!0).css("top",this.$container.outerHeight(!0))},this),1e3*this.settings.slideSpeed);break;case"fade":h.css({top:0,left:0,display:"none"}),o.fadeOut(1e3*this.settings.slideSpeed/2),setTimeout(t.proxy(function(){h.fadeIn(1e3*this.settings.slideSpeed/2),o.stop(!0,!0).css({top:this.$container.outerHeight(!0),display:"block"})},this),1e3*this.settings.slideSpeed/2);break;case"directFade":h.css({top:0,left:0,"z-index":0,display:"none"}),o.css({"z-index":1}),h.stop(!0,!0).fadeIn(1e3*this.settings.slideSpeed),o.stop(!0,!0).fadeOut(1e3*this.settings.slideSpeed),setTimeout(t.proxy(function(){h.stop(!0,!0).css({"z-index":0}),o.stop(!0,!0).css({top:this.$container.outerHeight(!0),display:"block","z-index":0})},this),1e3*this.settings.slideSpeed)}setTimeout(t.proxy(function(){o.removeClass("slideshow_currentView"),h.removeClass("slideshow_nextView"),h.addClass("slideshow_currentView"),this.visibleViews=[i],this.currentlyAnimating=!1,this.$container.trigger("slideshowAnimationEnd")},this),1e3*this.settings.slideSpeed)}}}();
!function(){var t=jQuery,i=slideshow_jquery_image_gallery_script;i.Slideshow.prototype.recalculate=function(i){if(!this.$container.is(":visible"))return setTimeout(t.proxy(function(){this.recalculate(i)},this),500),void 0;for(var e=this.$parentElement,s=0;e.width()<=0&&(e=e.parent(),!(s>50));s++);if(this.currentWidth!=e.width()){this.currentWidth=e.width();var n=e.width()-(this.$container.outerWidth()-this.$container.width());if(parseInt(this.settings.maxWidth,10)>0&&parseInt(this.settings.maxWidth,10)<n&&(n=parseInt(this.settings.maxWidth,10)),this.$container.css("width",Math.floor(n)),this.$content.css("width",Math.floor(n)-(this.$content.outerWidth(!0)-this.$content.width())),this.settings.preserveSlideshowDimensions){var a=n*this.settings.dimensionHeight/this.settings.dimensionWidth;this.$container.css("height",Math.floor(a)),this.$content.css("height",Math.floor(a)-(this.$content.outerHeight(!0)-this.$content.height()))}else this.$container.css("height",Math.floor(this.settings.height)),this.$content.css("height",Math.floor(this.settings.height));this.$views.each(t.proxy(function(i,e){t.inArray(i,this.visibleViews)<0&&t(e).css("top",this.$container.outerHeight(!0))},this)),this.$container.trigger("slideshowResize"),(i||"boolean"!=typeof i)&&this.recalculateVisibleViews()}},i.Slideshow.prototype.recalculateViews=function(){t.each(this.$views,t.proxy(function(t){this.recalculateView(t,!1)},this))},i.Slideshow.prototype.recalculateVisibleViews=function(){t.each(this.visibleViews,t.proxy(function(t,i){this.recalculateView(i,!1)},this))},i.Slideshow.prototype.recalculateView=function(e,s){if(this.$content.width()<=0||this.$content.height()<=0)return setTimeout(t.proxy(function(){this.recalculateView(e,s)},this),500),void 0;var n=t(this.$views[e]);if("boolean"==typeof s&&s||this.$content.width()!=n.outerWidth(!0)){var a=n.find(".slideshow_slide");if(!(a.length<=0)){var o=this.$content.width()-(n.outerWidth(!0)-n.width()),h=this.$content.height()-(n.outerHeight(!0)-n.height()),r=Math.floor(o/a.length),l=h,d=o%a.length,c=0;t(a[0]).css("margin-left",0),t(a[a.length-1]).css("margin-right",0),t.each(a,t.proxy(function(s,n){var o=t(n),h=o.outerWidth(!0)-o.width(),u=o.outerHeight(!0)-o.height();if(s==a.length-1?o.width(r-h+d):o.width(r-h),o.height(l-u),o.hasClass("slideshow_slide_text")){var p=o.find(".slideshow_background_anchor");if(p.length<=0)return;var w=o.width()-(p.outerWidth(!0)-p.width()),g=o.height()-(p.outerHeight(!0)-p.height());p.css({width:w,height:g})}else if(o.hasClass("slideshow_slide_image")){var y=o.find("img");if(y.length<=0)return;var f,v,m=y.outerWidth(),I=y.outerHeight();f=isNaN(parseInt(m))?0:m-y.width(),v=isNaN(parseInt(I))?0:I-y.height();var S=o.width()-f,P=o.height()-v;"stretch"===this.settings.imageBehaviour?(y.css({width:S,height:P}),y.attr({width:S,height:P})):this.getNaturalImageSize(y,t.proxy(function(i,s){var n,a;return 0>=i||0>=s?(setTimeout(t.proxy(function(){this.recalculateView(e,!0)},this),500),void 0):(n=o.width()/o.height(),a=(i+f)/(s+v),a>=n?"natural"===this.settings.imageBehaviour?(y.css({margin:"0px",width:S,height:Math.floor(S/a)}),y.attr({width:S,height:Math.floor(S/a)})):"crop"===this.settings.imageBehaviour&&(y.css({"margin-top":"0px","margin-left":-Math.floor((P*a-S)/2),height:P,width:Math.floor(P*a)}),y.attr({width:Math.floor(P*a),height:P})):"natural"===this.settings.imageBehaviour?(y.css({"margin-left":"auto","margin-right":"auto",display:"block",width:Math.floor(P*a),height:P}),y.attr({width:Math.floor(P*a),height:P})):"crop"===this.settings.imageBehaviour&&(y.css({"margin-top":-Math.floor((S/a-P)/2),"margin-left":"0px",width:S,height:Math.floor(S/a)}),y.attr({width:S,height:Math.floor(S/a)})),void 0)},this))}else if(o.hasClass("slideshow_slide_video")){var _=o.find("iframe");if(_.length>0)_.attr({width:o.width(),height:o.height()});else var $=setInterval(t.proxy(function(){if(i.youTubeAPIReady){clearInterval($);var e=o.find(".slideshow_slide_video_id");e.attr("id","slideshow_slide_video_"+Math.floor(1e6*Math.random())+"_"+e.text());var s=e.attr("data-show-related-videos"),n=new YT.Player(e.attr("id"),{width:o.width(),height:o.height(),videoId:e.text(),playerVars:{wmode:"opaque",rel:s},events:{onReady:function(){},onStateChange:t.proxy(function(t){this.videoPlayers[e.attr("id")].state=t.data},this)}}),a=t("#"+e.attr("id"));a.show(),a.attr("src",a.attr("src")+"&wmode=opaque"),this.videoPlayers[e.attr("id")]={player:n,state:-1}}},this),500)}c+=o.outerWidth(!0)},this)),n.css({width:o,height:h})}}}}();
