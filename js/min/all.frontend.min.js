function onYouTubeIframeAPIReady(){slideshow_jquery_image_gallery_script.youTubeAPIReady=!0}slideshow_jquery_image_gallery_backend_script_scriptsloadedFlag=!1,slideshow_jquery_image_gallery_script=function(){var e=jQuery,s={};return s.slideshowInstances={},s.initialized=!1,s.youTubeAPIReady=!1,s.init=function(){slideshow_jquery_image_gallery_backend_script_scriptsloadedFlag!==!0||s.initialized||(s.initialized=!0,e(document).trigger("slideshow_jquery_image_gallery_script_ready"),s.loadYouTubeAPI(),s.repairStylesheetURLs(),s.activateSlideshows(),e(document).trigger("slideshow_jquery_image_gallery_slideshows_ready"))},s.getSlideshowInstance=function(i){var t,n;if(isNaN(parseInt(i,10))){if(i instanceof e&&i.length>0)for(n in s.slideshowInstances)if(s.slideshowInstances.hasOwnProperty(n))if(e.isArray(s.slideshowInstances[n])){for(t=0;t<s.slideshowInstances[n].length;t++)if(s.slideshowInstances[n][t]instanceof s.Slideshow&&s.slideshowInstances[n][t].$container.get(0)===i.get(0))return s.slideshowInstances[n][t]}else if(s.slideshowInstances[n]instanceof s.Slideshow&&s.slideshowInstances[n].$container.get(0)===i.get(0))return s.slideshowInstances[n]}else if(s.slideshowInstances[i]instanceof s.Slideshow||e.isArray(s.slideshowInstances[i]))return s.slideshowInstances[i];return null},s.activateSlideshows=function(){e.each(jQuery(".slideshow_container"),function(i,t){var n,a=e(t),o=a.attr("data-slideshow-activated"),l=a.data("slideshowId");o||(isNaN(parseInt(l,10))&&(l=a.attr("data-slideshow-id")),n=new s.Slideshow(a),e.isArray(s.slideshowInstances[l])?s.slideshowInstances[l].push(n):s.slideshowInstances[l]=s.slideshowInstances[l]instanceof s.Slideshow?[s.slideshowInstances[l],n]:n,a.attr("data-slideshow-activated",!0))})},s.loadYouTubeAPI=function(){if(s.loadYouTubeAPICalled=!0,!(e(".slideshow_slide_video").length<=0)){var i=document.createElement("script"),t=document.getElementsByTagName("script")[0];i.src="//www.youtube.com/iframe_api",t.parentNode.insertBefore(i,t)}},s.repairStylesheetURLs=function(){var s=e('[id*="slideshow-jquery-image-gallery-ajax-stylesheet_"]');e.each(s,function(s,i){var t,n,a,o=e(i),l=e(i).attr("href");void 0!==l&&""!==l&&(t=o.attr("id").split("_"),n=t.splice(1,t.length-1).join("_").slice(0,-4),a=l.split("?"),(void 0===a[1]||""===a[1]||a[1].toLowerCase().indexOf("style=")<0)&&(a[1]="action=slideshow_jquery_image_gallery_load_stylesheet&style="+n+"&ver="+Math.round((new Date).getTime()/1e3),l=a.join("?"),o.attr("href",l)))})},e(document).ready(function(){s.init()}),e(window).load(function(){s.init()}),e.fn.getSlideshowInstance=function(){return s.getSlideshowInstance(this)},s}();
