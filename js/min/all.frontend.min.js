function onYouTubeIframeAPIReady(){slideshow_jquery_image_gallery_script.youTubeAPIReady=!0}slideshow_jquery_image_gallery_script=function(){var t=jQuery,i={};return i.slideshowInstances={},i.initialized=!1,i.youTubeAPIReady=!1,i.init=function(){i.initialized||(i.initialized=!0,i.loadYouTubeAPI(),i.checkStylesheetURLs(),i.activateSlideshows())},i.getSlideshowInstance=function(e){if(isNaN(parseInt(e,10))){if(e instanceof t&&e.length>0)for(var s in i.slideshowInstances)if(i.slideshowInstances.hasOwnProperty(s)){var n=i.slideshowInstances[s];if(n instanceof i.Slideshow&&n.$container.get(0)===e.get(0))return n}}else if(i.slideshowInstances[e]instanceof i.Slideshow)return i.slideshowInstances[e];return new i.Slideshow},i.activateSlideshows=function(){t.each(jQuery(".slideshow_container"),function(e,s){var n=t(s),o=n.data("sessionId");isNaN(parseInt(o,10))&&(o=n.attr("data-session-id")),i.slideshowInstances[o]instanceof i.Slideshow||(i.slideshowInstances[o]=new i.Slideshow(n))})},i.loadYouTubeAPI=function(){if(i.loadYouTubeAPICalled=!0,!(t(".slideshow_slide_video").length<=0)){var e=document.createElement("script"),s=document.getElementsByTagName("script")[0];e.src="//www.youtube.com/iframe_api",s.parentNode.insertBefore(e,s)}},i.checkStylesheetURLs=function(){var e=t('[id*="slideshow-jquery-image-gallery-ajax-stylesheet_"]');return e.length<=0?(i.generateStylesheetURLs(),void 0):(t.each(e,function(i,e){var s,n,o,a=t(e),h=t(e).attr("href");void 0!==h&&""!==h&&(s=a.attr("id").split("_"),n=s.splice(1,s.length-1).join("_").slice(0,-4),o=h.split("?"),(void 0===o[1]||""===o[1]||o[1].toLowerCase().indexOf("style=")<0)&&(o[1]="action=slideshow_jquery_image_gallery_load_stylesheet&style="+n+"&ver="+Math.round((new Date).getTime()/1e3),h=o.join("?"),a.attr("href",h)))}),void 0)},i.generateStylesheetURLs=function(){t(".slideshow_container"),$slideshows.length<=0||"string"!=typeof slideshow_jquery_image_gallery_script_backendURL&&slideshow_jquery_image_gallery_script_backendURL.length<=0||t.each($slideshows,function(i,e){var s,n=t(e),o=n.attr("data-stylesheet-name"),a=n.attr("data-stylesheet-version");"string"==typeof o&&"string"==typeof a&&o.length>0&&a.length>0&&(s=adminURL+"admin-ajax.php?action=slideshow_jquery_image_gallery_load_stylesheet&style="+o+"&ver="+a,t("head").append('<link rel="stylesheet" id="slideshow-jquery-image-gallery-ajax-stylesheet_'+o+'-css" href="'+s+'" type="text/css" media="all">'))})},t(document).ready(function(){i.init()}),t(window).load(function(){i.init()}),t.fn.getSlideshowInstance=function(){return i.getSlideshowInstance(this)},i}();
