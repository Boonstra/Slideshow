...
<table>
	...
	>
		...
		<td><?php echo SlideshowPluginSlideshowSettingsHandler::getInputField(SlideshowPluginSettingsProfile::SETTINGS_POST_META_KEY, htmlspecialchars($key), $variables[$key], $value); ?></td>
